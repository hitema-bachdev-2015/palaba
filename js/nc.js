...
$(document).ready(function () {
    ...
    $('body').append('<img src="' + url + 'img/nyancat.gif" id="image" width="100" style="position:fixed;z-index:9999;left:-100px;top:50px;"/>');
    var img = $("img#image");

    $('body').append('<audio id="sound" preload="auto"><source src="' + url + 'audio/nyancat.ogg" type="audio/ogg"/><source src="' + url + 'audio/nyancat.mp3" type="audio/mp3" /></audio>');
